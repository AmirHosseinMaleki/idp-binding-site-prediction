...
rna_df = pd.read_csv('data/protein_binding_raw.tsv', sep='\t')
...
dna_df = pd.read_csv('data/dna_binding_raw.tsv', sep='\t')
...
rna_df = pd.read_csv('data/rna_binding_raw.tsv', sep='\t')
...
ion_df = pd.read_csv('data/ion_binding_raw.tsv', sep='\t')
