...
# train_data = BindingDataset('/home/malekia/idp-binding-site-prediction/data/biolip/biolip_train_clustered.csv')
# val_data = BindingDataset('/home/malekia/idp-binding-site-prediction/data/biolip/biolip_val_clustered.csv')
train_data = BindingDataset(get_dataset_path(cfg, "biolip", "dna_train_csv"))
val_data   = BindingDataset(get_dataset_path(cfg, "biolip", "dna_val_csv"))
...
for epoch in range(EPOCHS):
    ...
    if val_loss < best_loss:
        best_loss = val_loss
        # torch.save(model.state_dict(), '/home/malekia/idp-binding-site-prediction/data/ScanNet/datasets/PPBS/rna_dna_phase1_model.pt')
        torch.save(model.state_dict(), get_model_path(cfg, "rna_dna_window_phase1"))
