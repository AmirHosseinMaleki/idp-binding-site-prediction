...
print("="*60)
print("Protein-Protein Binding - Model Comparison")
print("="*60)
...
print("="*60)
print(f"{'Model':<30} {'ScanNet AUC':<15} {'DisProt AUC':<15}")
print("-"*60)
for model_name, metrics in results.items():
    print(f"{model_name:<30} {metrics['scannet']['AUC']:<15.4f} {metrics['disprot']['AUC']:<15.4f}")
