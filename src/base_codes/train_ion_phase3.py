...
print("="*60)
print("Ion Phase 3: Hybrid Training (AHoJ-DB + DisProt)")
print("="*60)
...
val_data = CombinedDataset([get_embedding_path(cfg, "ahojdb_val"), get_embedding_path(cfg, "disprot_ion_val")])
...
for epoch in range(EPOCHS):
    ...
    if val_loss < best_loss:
        best_loss = val_loss
        # torch.save(model.state_dict(), 'ion_phase3_model.pt')
        torch.save(model.state_dict(), get_model_path(cfg, "ion_phase3"))
