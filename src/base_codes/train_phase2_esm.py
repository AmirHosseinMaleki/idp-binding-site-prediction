...
train_data = EmbeddingDataset(get_embedding_path(cfg, "disprot_protein_train"))
...
for epoch in range(EPOCHS):
    ...
    if val_loss < best_loss:
        ...
        torch.save(model.state_dict(), get_model_path(cfg, "protein_phase2"))
...
print(f"Model saved: {get_model_path(cfg, 'protein_phase2')}")
print(f"{'='*60}")